    ...
    <div className="section relative flex min-h-[80vh] items-center justify-center overflow-hidden">
      ...
      >
        <motion.div
          ...
          className="hover-target bg-primary/30 border-primary/20 pointer-events-auto absolute top-[20%] right-[20%] h-24 w-24 cursor-grab rounded-full border shadow-lg backdrop-blur-md active:cursor-grabbing"
        ...
        <motion.div
          drag
          dragConstraints={{ left: -100, right: 100, top: -100, bottom: 100 }}
          className="hover-target bg-secondary/30 border-secondary/20 pointer-events-auto absolute bottom-[20%] left-[20%] h-16 w-16 cursor-grab rounded-full border shadow-lg backdrop-blur-md active:cursor-grabbing"
      ...
      <div className="relative z-10 container flex flex-col items-center text-center">
        <motion.div
          ...
          className="mb-8"
        >
          <span className="glass-card inline-block px-8 py-4 text-8xl font-black md:text-9xl">
            404
          </span>
        </motion.div>
