    ...
    <div className="min-h-screen pt-24 pb-12">
      ...
      <div className="container">
        ...
        <div className="mb-12 md:mb-16">
          ...
          <p className="border-primary text-text-secondary max-w-2xl border-l-4 py-2 pl-6 text-xl leading-relaxed">
        ...
        <div className="mt-16 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              className="group relative flex items-center gap-2.5 overflow-hidden rounded-xl border px-6 py-3 text-sm font-bold transition-all duration-300 hover:scale-[1.03] active:scale-[0.97]"
              style={{
